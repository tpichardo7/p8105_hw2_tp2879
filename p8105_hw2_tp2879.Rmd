...
```{r}
viewers.info()
viewers.fillna(0, inplace - TRUE)
```

```{r}
avg_viewership_season_1 = viewers[viewers["season"] == 1]["viewers"].mean()
avg_viewership_season_5 = viewers[viewers["season"] == 5]["viewers"].mean()
```
